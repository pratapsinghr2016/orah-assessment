...
export const RollStateSwitcher: React.FC<Props> = ({ rollMode, size = 40, studentDetail, tableProps }) => {
  ...
  return <RollStateIcon selectedRollType="" rollMode={rollStates[rollIdx]} size={size} onClick={() => onClick(rollIdx)} />
}
